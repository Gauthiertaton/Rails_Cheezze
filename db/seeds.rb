...
RacletteMachine.create!(name: "Severin RG 9640", price: '15€', capacity: '6', address: Faker::Address.full_address, accessories: '6 poêlons', user_id: user_id.sample)
RacletteMachine.create!(name: "Moulinex RE160811", price: '4€', capacity: '6', address: Faker::Address.full_address, accessories: '6 poêlons', user_id: user_id.sample)
RacletteMachine.create!(name: "H.Koenig RP80", price: '7€', capacity: '6', address: Faker::Address.full_address, accessories: '6 poêlons', user_id: user_id.sample)
RacletteMachine.create!(name: "Tefal RE511412", price: '5€', capacity: '4', address: Faker::Address.full_address, accessories: '4 poêlons', user_id: user_id.sample)
RacletteMachine.create!(name: "Lagrange 009801 transparence", price: '16€', capacity: '8', address: Faker::Address.full_address, accessories: '8 poêlons', user_id: user_id.sample )
RacletteMachine.create!(name: "Tefal PR 457812 Raclette Pierrade", price: '2€', capacity: '6', address: Faker::Address.full_address, accessories: '6 poêlons', user_id: user_id.sample )
RacletteMachine.create!(name: "Russell Hobbs Quator 4 en 1", price: '4€', capacity: '4', address: Faker::Address.full_address, accessories: '4 poêlons', user_id: user_id.sample)
